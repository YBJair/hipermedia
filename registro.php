...
<body>
  ...
  <main>
    <form action="" method="POST">
      ...
      <p><label for="birth" >Fecha de nacimiento: </label><input id="birth" type="date" name="birth" required>
      ...
      <p><label for="profile">Imagen de perfil: </label><input id="profile" name="img" type="file"/></p>
